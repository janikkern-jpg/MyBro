...
export default async (req: Request, _context: Context): Promise<Response> => {
  ...
  // ---------------------------------------------------------------
  // Server-seitig erzwungene Fähigkeits-Reminder. Bewusst UNABHÄNGIG
  // vom Client-System-Prompt: gecachte alte Bundles könnten sonst
  // weiterhin ein veraltetes System senden, das die Bild-Bearbeitung
